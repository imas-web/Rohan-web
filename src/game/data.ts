...
export const CLASSES: ClassDef[] = [
  {
    ...
    description: 'Pelea cuerpo a cuerpo con espada. Golpe en área alrededor tuyo: buena para cuando te rodean.',
    cooldown: 20,
    color: '#C1502E',
  },
  {
    ...
    ranged: false,
    bodyScale: 0.82,
    ultimateName: 'Coraza de Forja',
    description: 'Pelea cuerpo a cuerpo con hacha. Te cura y te vuelve casi inmune al daño por unos segundos.',
    cooldown: 26,
    color: '#8A7A5C',
  },
  {
    ...
    description: 'Ataca a distancia con arco y flechas. Daño en un área amplia, ideal contra grupos.',
    cooldown: 22,
    color: '#7FD1AE',
  },
  {
    ...
    ranged: true,
    bodyScale: 1,
    ultimateName: 'Tormenta Arcana',
    description: 'Ataca a distancia con hechizos de bastón. Descarga una tormenta arcana en un área muy amplia.',
    cooldown: 24,
    color: '#8A4C9B',
  },
]
